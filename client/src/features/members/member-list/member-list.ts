import { Component, inject, OnInit, resource, signal, ViewChild, viewChild } from '@angular/core';
...
export class MemberList implements OnInit {
  ...
  protected memberParams = new MemberParams(); // Current filter and pagination params
  private updatedParams = new MemberParams(); // To track changes for display message
  ...
  onFilterChange(data: MemberParams) {
    this.memberParams = {...data}; // Update current params
    this.updatedParams = {...data}; // Update the tracking params
    this.loadMembers();
  }
